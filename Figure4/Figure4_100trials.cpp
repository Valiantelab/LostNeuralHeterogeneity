...
#define Trials 100//number of trials (if averaging is needed)
...
int main (int argc, char *argv[])
{
    ...
    int n;
    ofstream outfile;
    n=sprintf(output3,"SpikingNEWNEW_p%2.0f_sige%2.0f_sigi%2.0f_Trials%d_gamma%3.0f.csv", p_connectivity*100, sigmae*10, sigmai*10, Trials, gamma*1000);
    outfile.open(output3, ios::out);
    
    ofstream outfile3;
    n=sprintf(output4,"SpikingInhibNEWNEW_p%2.0f_sige%2.0f_sigi%2.0f_Trials%d_gamma%3.0f.csv", p_connectivity*100, sigmae*10, sigmai*10, Trials, gamma*1000);
    outfile3.open(output4, ios::out);
    
    ofstream outfile2;
    n=sprintf(output2,"DynamicsNEWNEW_p%2.0f_sige%2.0f_sigi%2.0f_Trials%d_gamma%3.0f.csv", p_connectivity*100, sigmae*10, sigmai*10, Trials, gamma*1000);
